...
function runTheTicker() {
    ...
    if (theTargetLink) {
        ...
        if (NS6) {
            document.getElementById("theTicker").innerHTML = '<a  target="_self" style="font-size:16px; color:#434343; text-decoration:none; font-family:iran-sans2;" href="' + theTargetLink + '" target="_top">' + textTitle + '</a>';
        }
        else {
